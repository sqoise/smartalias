...
export default function MyRequestsContainer({ toastRef, selectedDocumentType = 'all' }) {
  ...
  const loadRequests = async () => {
    ...
    try {
      ...
      toastRef?.current?.show('Failed to load your document requests', 'error')
      setRequests([])
    } finally {
      setLoading(false)
    }
    ...
    <div className="space-y-3">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-100">
          ...
          <p className="text-sm text-gray-500 mt-0.5">Track your document requests by type</p>
        </div>
